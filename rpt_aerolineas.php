...
<?php
	...
	class PDF extends FPDF
	{
		...
		function Header()
		{
		    ...
		    $this->Cell(80);
		    // Título
		    $this->Cell(30,10,'Registro de Aerolineas',0,1,'C');
	...
	$query = "select a.RUC, A.nombre, AL.cod_alianza, AL.nombre_alianza from aerolinea  a inner join alianza_aerea  al on a.cod_alianza = al.cod_alianza";
	...
	$header = array('RUC', 'Aerolinea', 'Codigo de Alianza', 'Alianza Aerea');
	$w = array(50, 50, 40, 50);
	$pdf->AliasNbPages();
	$pdf->SetFont('Arial','',9);
	$pdf->AddPage();
